...
plots_id=$(sbatch --parsable --dependency=afterok:$create_ann_training_data_id:$create_ann_eval_id:$classics_id /lustre/ssd/ws/s5968580-IL_TD2/imitating-weakal//slurms2/uncertainty/plots.slurm)
exit 0
