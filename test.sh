...
# for i in {1..10}
# do
#     python single_al_cycle.py --OUTPUT_DIRECTORY trained_mlp --NN_BINARY tmp/_vd_true_30000_rf_true_-1_h_false_nsp_true_chs_true_2_nqpi_true_samar_false_mlp/trained_ann.pickle --SAMPLING trained_nn --CLUSTER dummy --NR_QUERIES_PER_ITERATION 1 --DATASET_NAME synthetic --START_SET_SIZE 1 --USER_QUERY_BUDGET_LIMIT 20 --RANDOM_SEED $i --N_JOBS 8 --PLOT_EVOLUTION --AMOUNT_OF_FEATURES 2 --NR_LEARNING_ITERATIONS 20 --CONVEX_HULL_SAMPLING --VARIABLE_INPUT_SIZE --NEW_SYNTHETIC_PARAMS --HYPERCUBE --REPRESENTATIVE_FEATURES --CLASSIFIER mlp
# done
 
for i in {1..10}
do
    python single_al_cycle.py --OUTPUT_DIRECTORY unc_mlp --SAMPLING uncertainty_max_margin --CLUSTER dummy --NR_QUERIES_PER_ITERATION 1 --DATASET_NAME synthetic --START_SET_SIZE 1 --USER_QUERY_BUDGET_LIMIT 20 --RANDOM_SEED $i --N_JOBS 8 --PLOT_EVOLUTION --AMOUNT_OF_FEATURES 2 --NR_LEARNING_ITERATIONS 20 --CONVEX_HULL_SAMPLING --VARIABLE_INPUT_SIZE --NEW_SYNTHETIC_PARAMS --HYPERCUBE --CLASSIFIER MLP
done
